...
- (void) layoutSubviews {
    ...
    if (self.isWritingComment) {
        ...
        //assignment attempt
        //self.button.frame = animateWithDuration:1 delay:0 usingSpringWithDamping:.5 initialSpringVelocity:.5 options:nil animations:(void (^) (void)) completion:(void (^) (BOOL YES));
    }
