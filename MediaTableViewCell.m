...
+ (void)load {
    ...
    usernameLabelGray = [UIColor colorWithRed:1.00 green:0.50 blue:0.00 alpha:1.0]; /*#eeeeee*/
    //changed to orange
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        for (UIView *view in @[self.mediaImageView, self.usernameAndCaptionLabel, self.commentLabel, self.likeButton, self.commentView, self.likesLabel]) {
        ...
        NSDictionary *viewDictionary = NSDictionaryOfVariableBindings(_mediaImageView, _usernameAndCaptionLabel, _commentLabel, _likeButton, _commentView, _likesLabel);
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_likesLabel]|" options:kNilOptions metrics:nil views:viewDictionary]];
...
- (void) setMediaItem:(Media *)mediaItem {
    ...
    //self.likesLabel.text = LikeStateLiked;
